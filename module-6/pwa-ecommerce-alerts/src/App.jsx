...
function App() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'sans-serif', maxWidth: '500px', margin: '0 auto' }}>
      <h1>🛍️ Deal Alerts from sanju</h1>
      
      {/* --- INSTALL APP BUTTON --- */}
      {deferredPrompt && (
        <div style={{ padding: '15px', background: '#f6f2f1', borderRadius: '8px', marginBottom: '20px' }}>
          <p>Get the best experience by installing our app!</p>
          <button onClick={handleInstallClick} style={{ padding: '10px', background: '#1eb100', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
            Install App
          </button>
        </div>
      )}
